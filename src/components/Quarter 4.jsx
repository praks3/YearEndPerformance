              ...
              <div className="bg-gray-700 text-gray-200 p-6 flex-1">
                <ul className="list-disc list-inside space-y-2 text-left text-sm md:text-base m-0">
                  <li>
                    ...
                    <span className="text-blue-400 font-semibold">1 Minor</span>
                  </li>
                  <li>
                    Total PDT Done –
              ...
              <div className="bg-gray-700 text-gray-200 p-6 flex-1">
                <ul className="list-disc list-inside space-y-2 text-left text-sm md:text-base m-0">
                  ...
                  <li>
                    ...
                    - Assisted in content verification by comparing data between
                    Excel sheets and Figma designs, and evaluated the top three
                    AI platforms to identify key features.
                  </li>
                  <li>
                    Total Issues –
                    <span className="text-orange-400 font-semibold">
          ...
          <div className="flex flex-col">
            ...
            <div className="bg-white hover:shadow-xl shadow-md p-8 border-4 border-gray-900 rounded-lg transition-all duration-300 hover:-translate-y-2 flex-grow">
              <ul className="list-disc list-inside space-y-4 font-bold text-lg text-left">
                <li>
                  Monthly Review Website- Designed and implemented the login
                  flow while establishing the backend project structure for the
                  Monthly Review website. Managed sprint planning, defined
                  system logic, delegated responsibilities, and supported the
                  team by resolving queries.
                </li>
              </ul>
            </div>
          </div>
